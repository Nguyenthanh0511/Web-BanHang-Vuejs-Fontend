...
export default {
    ...
    methods: {
        async editProduct() {
            ...
            .then(() => {
                ...
                swal({
                    text: "product has been update successfully",
                    icon: "success"
                })
    ...
    mounted() { 
        // Âns nút trên màn hình (login) , html basic không có login 
        // element component init chưa lên màn hình , then init add vào ele html , 
        // sau khi chuyển sang màn hình khác thì sẽ unmounted  
        this.id = this.$route.params.id;
        this.product = this.products.find(product => product.id == this.id)
        //bonus link : https://vuejs.org/guide/essentials/lifecycle
    }
}
</script>